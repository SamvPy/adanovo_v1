...
def evaluate(
    ...
    """
    Evaluate peptide sequence predictions from a trained Adanovo model.
...
def _execute_existing(
    ...
    """
    Predict peptide sequences with a trained Adanovo model with/without
    evaluation.
